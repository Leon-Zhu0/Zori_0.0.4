...
public class Zori
{
    ...
    public Zori() {
        this.log = LogManager.getLogger(Zori.MODNAME);
        Zori.instance = this;
    }
    ...
    public void init(final FMLInitializationEvent event) {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(Zori.MODNAME + " shutdown hook") {
            @Override
            public void run() {
                try {
                    config.save();
    ...
    public String toString() {
        return Zori.MODNAME + " " + "v0.0.4-BETA";
    }

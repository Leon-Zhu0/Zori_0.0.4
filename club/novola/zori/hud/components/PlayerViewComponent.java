...
public class PlayerViewComponent extends HudComponent<PlayerViewer>
{
    ...
    public void render() {
        ...
        this.drawPlayer((EntityPlayer)Wrapper.mc.player, this.x, this.y);
    ...
    public void drawPlayer(final EntityPlayer player, final int x, final int y) {
        ...
        GlStateManager.scale(-1.0f * ((PlayerViewer)this.module).scale.getValue(), 1.0f * ((PlayerViewer)this.module).scale.getValue(), 1.0f * ((PlayerViewer)this.module).scale.getValue());

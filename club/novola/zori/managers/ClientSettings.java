...
public class ClientSettings
{
    ...
    public ClientSettings() {
        this.colors = (Colors)Zori.getInstance().moduleManager.getModuleByName("Colors");
        this.settings = (Settings)Zori.getInstance().moduleManager.getModuleByName("Settings");
    }

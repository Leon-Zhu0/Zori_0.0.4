...
import club.novola.zori.command.commands.ClientNameCommand;
...
public class CommandManager
{
    ...
    public CommandManager() {
        this.commands = (List<Command>)Lists.newArrayList((Object[])new Command[] { new ToggleCommand(), new StatusCommand(), new ClientNameCommand() });

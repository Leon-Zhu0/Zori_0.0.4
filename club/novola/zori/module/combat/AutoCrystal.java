...
public class AutoCrystal extends Module
{
    ...
    private Setting<Boolean> toggleMsgs;
    private Setting<Integer> espAlpha;
    ...
    public AutoCrystal() {
        ...
        this.toggleMsgs = (Setting<Boolean>)this.register("ToggleMsgs", true);
        this.espAlpha = (Setting<Integer>)this.register("EspAlpha", 50, 0, 255);
        this.tickCounter = 0;
        this.attempts = 0;
    ...
    public void onRender3D() {
        if (this.espAlpha.getValue() > 0 && Wrapper.getPlayer() != null && Wrapper.getWorld() != null) {
            if (this.target != null) {
                RenderUtils.INSTANCE.drawBoundingBox(this.target.getRenderBoundingBox(), Zori.getInstance().clientSettings.getColor(this.espAlpha.getValue()), 1.0f);
            }
            if (this.renderPos != null) {
                RenderUtils.INSTANCE.drawBox(this.renderPos, Zori.getInstance().clientSettings.getColor(this.espAlpha.getValue()));
            }
        }
    }

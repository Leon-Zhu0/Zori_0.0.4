...
public class KillAura extends Module
{
    ...
    public void onUpdate() {
        ...
        if (this.mode.getValue().equals(Mode.SMART)) {
            ...
            if (((AutoCrystal)Zori.getInstance().moduleManager.getModuleByName("AutoCrystal")).isActive) {
                return;
            }
        }
    ...
    public void onSendPacket(final PacketSendEvent event) {
        if (event.getPacket() instanceof CPacketUseEntity) {
            ...
            if (this.crits.getValue() && packet.getAction().equals((Object)CPacketUseEntity.Action.ATTACK) && Wrapper.getPlayer() != null && Wrapper.getPlayer().onGround && this.isAttacking) {
                Wrapper.mc.player.connection.sendPacket((Packet)new CPacketPlayer.Position(Wrapper.mc.player.posX, Wrapper.mc.player.posY + 0.11, Wrapper.mc.player.posZ, false));
                Wrapper.mc.player.connection.sendPacket((Packet)new CPacketPlayer.Position(Wrapper.mc.player.posX, Wrapper.mc.player.posY + 0.11, Wrapper.mc.player.posZ, false));
                Wrapper.mc.player.connection.sendPacket((Packet)new CPacketPlayer.Position(Wrapper.mc.player.posX, Wrapper.mc.player.posY + 0.1100013579, Wrapper.mc.player.posZ, false));
                Wrapper.mc.player.connection.sendPacket((Packet)new CPacketPlayer.Position(Wrapper.mc.player.posX, Wrapper.mc.player.posY + 0.1100013579, Wrapper.mc.player.posZ, false));
                Wrapper.mc.player.connection.sendPacket((Packet)new CPacketPlayer.Position(Wrapper.mc.player.posX, Wrapper.mc.player.posY + 0.1100013579, Wrapper.mc.player.posZ, false));
                Wrapper.mc.player.connection.sendPacket((Packet)new CPacketPlayer.Position(Wrapper.mc.player.posX, Wrapper.mc.player.posY + 0.1100013579, Wrapper.mc.player.posZ, false));
                Wrapper.mc.player.connection.sendPacket((Packet)new CPacketPlayer.Position(Wrapper.mc.player.posX, Wrapper.mc.player.posY, Wrapper.mc.player.posZ, false));
            }
        }
    }

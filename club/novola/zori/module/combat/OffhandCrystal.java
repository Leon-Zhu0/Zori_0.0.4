...
public class OffhandCrystal extends Module
{
    ...
    public void onEnable() {
        if (this.disableOthers.getValue()) {
            final AutoTotem autoTotem = (AutoTotem)Zori.getInstance().moduleManager.getModuleByName("AutoTotem");
            final OffhandGap offhandGap = (OffhandGap)Zori.getInstance().moduleManager.getModuleByName("OffhandGap");
    ...
    public void onUpdate() {
        ...
        final Item item = this.shouldTotem() ? Items.TOTEM_OF_UNDYING : Items.END_CRYSTAL;
